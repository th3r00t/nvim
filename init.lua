...
require("colorpicker")  -- lua/colorpicker.lua
require("recorder")     -- lua/recorder.lua
-- Miscellaneous
...
-- require('boo-colorscheme').use({ theme = 'radioactive_waste', italic = true})
-- require('boo-colorscheme').use({ theme = 'sunset_cloud', italic = true})
-- require('boo-colorscheme').use({ theme = 'forest_stream', italic = true})
-- require('boo-colorscheme').use({ theme = 'crimson_moonlight', italic = true})
