...
mapx.nname("<C-x>", "+Actions")
  ...
  nnoremap("<C-x>h", ":split<Cr>", "hsplit")
  nnoremap("<C-x>v", ":vsplit<Cr>", "hsplit")
...
mapx.nname("<C-c>", "Control Systems")
  ...
  nnoremap("<C-c>t", ":TodoTelescope<Cr>", "Todo's")
  ...
  mapx.nname("<C-c>g", "+Git Commands")
    nnoremap("<C-c>gc", ":lua require'telescope.builtin'.git_commits()<Cr>", "git commits")
    nnoremap("<C-c>gC", ":lua require'telescope.builtin'.git_bcommits()<Cr>", "git buffer commits")
    nnoremap("<C-c>gs", ":lua require'telescope.builtin'.git_status()<Cr>", "git status")
    nnoremap("<C-c>gb", ":lua require'telescope.builtin'.git_branches()<Cr>", "git branches")
